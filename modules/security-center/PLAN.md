...
**Статус:** production MVP расширен до `0.8.0`; Security Campaign и обе части
...
и opt-in автоматическим quick scan реализованы. Следующий этап — отдельный
approval-поток для карантина.
