...
- [Security Center Quarantine Panel API v9](Architecture/api/security-center-quarantine-panel-v9.md)
...
- [Решение о подтверждении карантина в панели](Architecture/decisions/ADR-038-security-quarantine-panel-approval.md)
