...
Базовый профиль содержит **95 позиций**:

- обычные тесты проекта, тесты лаборатории, preflight точной `qwen3.5:2b`;
- 18 contract-сценариев и 7 дополнительных: RU/EN память на 5/35 ходах,
...
- каждый из 46 live-cases проходит дважды с seeds 7 и 19.
