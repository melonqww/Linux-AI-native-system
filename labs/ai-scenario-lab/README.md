...
Базовый профиль содержит **97 позиций**:

- обычные тесты проекта, тесты лаборатории, preflight точной `qwen3.5:2b`;
- 19 contract-сценариев и 7 дополнительных: RU/EN память на 5/35 ходах,
...
- каждый из 47 live-cases проходит дважды с seeds 7 и 19.
