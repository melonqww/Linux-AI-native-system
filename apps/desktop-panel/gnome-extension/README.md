...
Подтверждённые находки можно переместить в обратимый карантин. Панель сначала
показывает отдельный preview, а затем запрашивает явное подтверждение. Объекты из
раздела «Карантин» восстанавливаются отдельным подтверждаемым действием; занятый
исходный путь никогда не перезаписывается.
