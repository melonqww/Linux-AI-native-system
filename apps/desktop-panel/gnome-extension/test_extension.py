...
class GnomeExtensionFilesTest(unittest.TestCase):
    ...
    def test_native_panel_contract_is_present(self):
        ...
        for marker in (
            ...
            "inferenceStatus",
            "softwareSnapshot",
            "this._runtime.softwareSnapshot()",
            ...
            "this._runtime.securityJobStart(payload)",
            "this._runtime.securityJobStatus(jobId)",
            "this._runtime.securityJobStatus()",
            "this._runtime.securityJobCancel(this._securityJobId)",
            "this._runtime.securityJobSettings(enabled)",
            "this._runtime.securityQuarantinePrepare(item.findingId)",
            "this._runtime.securityQuarantineCommit(",
            "this._runtime.securityQuarantineRestore(",
            "this._runtime.securityQuarantineCancel(receipt.quarantine_id)",
            "securityJobPresentation(job)",
            ...
            "homeRelativePathFromUri(uri)",
            "SECURITY_SCAN_TITLES[payload.target]",
            "Проверка файла",
            "Проверка папки",
            "Отменить проверку",
            "Автоматические проверки: выкл",
            "_discoverSecurityJob()",
            "notifyUser(`${scanTitle} завершена`",
