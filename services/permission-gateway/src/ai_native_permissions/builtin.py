...
def builtin_policies() -> tuple[CapabilityPolicy, ...]:
    return (
        ...
        CapabilityPolicy(
            ...
            risk=RiskLevel.REVERSIBLE_WRITE,
            plan_approval_required=True,
            allowed_arguments=frozenset({"finding_id"}),
            required_arguments=frozenset({"finding_id"}),
            phases=(
                PhasePolicy(
                    ExecutionPhase.PREPARE,
                    SECURE_WRITE_TRANSPORTS,
        ...
        CapabilityPolicy(
            capability_id="security.quarantine.commit",
            risk=RiskLevel.REVERSIBLE_WRITE,
            plan_approval_required=True,
            allowed_arguments=frozenset({"quarantine_id"}),
            required_arguments=frozenset({"quarantine_id"}),
            phases=(
                PhasePolicy(
                    ExecutionPhase.COMMIT,
                    SECURE_WRITE_TRANSPORTS,
        ...
        CapabilityPolicy(
            capability_id="security.quarantine.restore",
            risk=RiskLevel.REVERSIBLE_WRITE,
            plan_approval_required=True,
            allowed_arguments=frozenset({"quarantine_id"}),
            required_arguments=frozenset({"quarantine_id"}),
            phases=(
                PhasePolicy(
                    ...
                    SECURE_WRITE_TRANSPORTS,
                    frozenset(
                        {"security.write-quarantine", "filesystem.write-content"}
                    ),
                    approval_required=True,
                ),
            ),
